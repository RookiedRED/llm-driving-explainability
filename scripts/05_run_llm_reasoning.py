...
OUT_PATH = Path("data/derived/predictions_stub_v1.jsonl")
        ...
        for line in fin:
            ...
            record = {
                ...
                "state_risk": {
                    ...
                    "closest_front_object_m": state.get("risk_physics", {}).get(
                        "closest_front_object_m"
                    ),
                    "required_deceleration_mps2": state.get("risk_physics", {}).get(
